...
将 `WeChat26Demo_v0.3.3_PhotoHomeGroupFix_flat.zip` 放到手机 `/var/mobile`，执行：
...
rm -rf wcdemo-v033
mkdir -p wcdemo-v033
unzip -oq WeChat26Demo_v0.3.3_PhotoHomeGroupFix_flat.zip -d wcdemo-v033 || exit 1
...
应用版本 0.3.3，构建号 8，Bundle ID 仍为 `com.xyy.wechat26demo`。覆盖安装不会主动清空 0.3.2 的聊天、联系人、图片、头像、壁纸和草稿。
